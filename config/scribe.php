...
return [
    ...
    'title' => 'Dentix API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'RESTful API for managing roles, permissions, and users in a dental SaaS platform. Uses Laravel Sanctum for authentication and Spatie Laravel Permission for role-based access control (RBAC).',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by sending a POST request to <code>/api/auth/login</code> with your credentials.',
    ],
